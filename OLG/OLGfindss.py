...
from OLGfuncs import Modeldefs, Modeldyn
...
params1 = np.array([alpha, beta, gamma, delta, chi, theta, tau, rho_z, \
    sigma_z, pi2, pi3, pi4, f1, f2, f3, nx, ny, nz])

# save in list
LINparams = (zbar, Zbar, NN, nx, ny, nz, logX, Sylv)

# take a guess for steady state values of k and l
guessXY = np.array([.01, .02, .03, .1, .1, .1])

# find the steady state values using LinApp_FindSS
XYbar1 = LinApp_FindSS(Modeldyn, params1, guessXY, Zbar, nx, ny)
(k2bar1, k3bar1, k4bar1, l1bar1, l2bar1, l3bar1) = XYbar1
kbar1 = np.array([k2bar1, k3bar1, k4bar1])
lbar1 = np.array([l1bar1, l2bar1, l3bar1])
...
Kbar1, Lbar1, GDPbar1, wbar1, rbar1, T4bar1, Bbar1, c1bar1, c2bar1, c3bar1, \
    c4bar1, Cbar1, Ibar1, u1bar1, u2bar1, u3bar1, u4bar1 = Modeldefs(kbar1, \
    kbar1, lbar1, 0., params1)
    
bar1 = np.array([k2bar1, k3bar1, k4bar1, l1bar1, l2bar1, l3bar1, Kbar1, \
...
(k2bar2, k3bar2, k4bar2, l1bar2, l2bar2, l3bar2) = XYbar2
kbar2 = np.array([k2bar2, k3bar2, k4bar2])
lbar2 = np.array([l1bar2, l2bar2, l3bar2])

# set up SS theta vector
theta1 = np.array([k2bar2, k3bar2, k4bar2, k2bar2, k3bar2, k4bar2, k2bar2, \
...
bar2 = np.array([k2bar2, k3bar2, k4bar2, l1bar2, l2bar2, l3bar2, Kbar2, \
    ...
    c4bar2, Cbar2, Ibar2, u1bar2, u2bar2, u3bar2, u4bar2])
